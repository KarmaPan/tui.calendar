...
var Week = {
    ...
    getViewModelForTimeView: function(start, end, time, options) {
        ...
        var _getViewModel = Week._makeGetViewModelFuncForTimeView(options);
     ...
     * it add filter
     * @param {Object} options - start, end hour
     * @returns {function} function
     */
    _makeGetViewModelFuncForTimeView: function(options) {
        var hourStart = options.hourStart;
        var hourEnd = options.hourEnd;
    ...
    findByDateRange: function(start, end, panels, andFilters, options) {
        ...
        util.forEach(panels, function(panel) {
            ...
            if (panel.type === 'daygrid') {
                ...
                group[name] = ctrlWeek.getViewModelForTimeView(start, end, group[name], options);
            }
        });
